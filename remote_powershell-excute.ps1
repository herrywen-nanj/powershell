...
#设置超时时间3600毫秒，也就是3.6秒，默认三分钟，看具体项目，参考：https://docs.microsoft.com/zh-cn/powershell/module/microsoft.powershell.core/new-pssessionoption?view=powershell-5.0
